...
IBM has a long and storied history in the technology world. Over a
century of products and services are being challenged like never
before. In order to survive and thrive, IBM has made numerous changes
and adaptations have been necessary to achieve survival. The latest of
those changes has been to an important product--IBM BlueMix. To thrive
in the current computing environment, BlueMix has become IBM Cloud
\cite{hid-sp18-525-cloud}. Cloud is a concept that has recently become
popular. With the advent of cloud, many companies have moved
operations to the cloud, in order to embrace the new world of data and
computing. IBM has taken steps to enter this world, with the latest
steps being the change from BlueMix, to IBM Cloud. IBM offers the
cloud on several different levels and with options to suit any size
business.

This paper focuses on IBM Cloud, and includes What is the Cloud, from
IBM. Why a move to the cloud is necessary discusses the necessity,
when considering that most businesses will have a cloud presence,
soon. Services beyond the cloud are also provided by IBM, such as data
analytics.
...
IBM also offers solutions for customers who do not want to fully
